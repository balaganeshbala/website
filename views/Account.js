      ...
      return (
         <div id="account">
            <div id="account-title">
                <Title text="STAY CONNECTED" textWidth="200px" bgColor="#88CBAA" textColor="#88CBAA"/>
            </div>
            <div id="account-content">
              <table width="300px" style={{ margin: "auto", tableLayout: "fixed" }}>
                <tbody>
                    <tr>
                        <th style={{ height: "100px" }}>
                            <a className="account-icon" href="https://in.linkedin.com/in/balaganeshbala" target="_blank">
                                <div className="account-icon-image">

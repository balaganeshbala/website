  	...
  	render() {
	  	return(<div id="about-container">
	  				...
	  				<p id="about-text">
                  		...
                  		{ ". My interests are in computer programming, drawing and UI designing. I'm not a religious person but not an atheist. I'm a pescatarian. I love classical music. I'm a keen reader of online articles." }
	  				</p>
			   </div>);
  	}
}